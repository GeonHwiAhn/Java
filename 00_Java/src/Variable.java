...
public class Variable {
	...
	public static void main(String[] args) {
		...
		System.out.println("바이트");
		//파일을 저장할 때 키보드에서 ctrl + s를 눌러주면 저장됨
		byte bt = 2;
		...
		//byte 자료형 선언 선언이름 bte bte 안에다가 숫자 2 넣고 출력하기
		byte bte = 2;
		System.out.println(bte);
		
		//short 자료형 선언 선언이름 shrt shrt 안에다가 숫자 2 넣고 출력하기
		short shrt = 2;
		System.out.println(shrt);
		
		//int 자료형 선언 선언이름 nt nt 안에다가 숫자 2 넣고 출력하기
		int nt = 2;
		System.out.println(nt);
		
		//long 자료형 선언 선언이름 lng lng 안에다가 숫자 2 넣고 출력하기
		long lng = 2;
		...
		// 문자에는 char와 string이 있음
			...
			//double은 크기가 float 보다 크고 
			//애초에 double을 넣으려고 시도했기 때문에
