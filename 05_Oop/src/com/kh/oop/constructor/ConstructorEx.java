package com.kh.oop.constructor;
	/* 생성자
	 ...
	 1. 반환값이 없음(return 사용 x, void x 위 두개로 선언하지 않음)
	...
	public class ConstructorEx{
		...
		//생성자 기본	/ 필수 / 값을 생성한 생성자
		// 기본생성자 : 필수로 아무것도 넣지 않은 생성자
		public ConstructorEx() {
			
		}
		// 필수생성자 괄호 안에 매개변수가 필수로 들어가야하는 생성자
		// 媒(중매)매   介(개입)개    變(변하다)변   數(숫자가)수
		//					(괄호안에 들어가는 변수 매개변수)
		// 					필수로 이름
		...
		public ConstructorEx(int a) {
			...
			idNo  = 			1;	  //int이기 때문에 문자열을 넣어야함
			money = 			0;	  //int이기 때문에 문자열을 넣어야함
		}
