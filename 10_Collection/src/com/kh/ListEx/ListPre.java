...
/*
      ┌ Vector	   : Java1 버전대에서 제일 먼저 등장해서 사용된 것
List  ├ ArrayList  : 검색에 좋음 삽입과 삭제가 빈번한경우 부적합
	  └ LinkedList : 검색에는 부적합, 데이터 삽입과 삭제에는 좋음
...
//void : 벡터
	...
	public void LinkedEx() {
		//LinkList<String> 링크드리스트 = new LinkedList<>();
