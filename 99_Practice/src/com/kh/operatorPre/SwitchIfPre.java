...
public class SwitchIfPre {
	...
	public static void controlPractice1() {
		//키보드로 입력받고 입력 수정 조회 삭제 종료버튼 눌러서 실행하기
		Scanner sc = new Scanner(System.in);
	...
	public static void controlPractice10() {
		...
		*/
		...
		/* System.out.print에서 출력할 내용이 길어져서
		   \n 줄바꿈으로 글을 작성하고 싶다면 이용해서 줄바꿈해서 출력하겠다는 뜻
		   원화 모양 = \
		   \n = 세로로 줄바꿈해서 출력
	...
	/*
	   // ! 특정 조건을 부정하는데 사용
	    inputID. equals(userID) : inputID와 userID가 일치하는지 확인
	      > 일치하면 참
	...
	public static void controlPractice6() {
		...
		// 권한이나 규칙을 설정할때 자주 사용하는 변수명은 role
		...
		case "비회원" :
			...
			break;
		default : 
			System.out.println("잘못된 회원등급입니다.");
		}
	...
	public static void controlPractice8() {
		...
		case "*" : 
			...
			// / % 0으로 나눌 수 없기 때문에 if문으로 값이 0이 될 경우 처리해줘야
		case "/" : 
			if (num2 == 0) {
