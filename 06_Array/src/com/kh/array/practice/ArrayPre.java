...
//메서드
	...
	public void practice1() {
		...
		//for-each 문 처음부터 끝까지 반복해서 무언가 진행할 때 사용
		//				{1, 2, 3, 4, 5};
		for(   int 숫자 :    num             ) {
	...
	public void practice2() {
		...
		//	new ArrayList<>는 <>안에 String을 넣어도 되고 안 넣어도 됨
	...
	public void practice4() {
		...
		for(    String f		:    fruits              ) {
			...
			if(f.equals(search)) {
				found = true;
				break; // 찾았기 떄문에 이름이 똑같은지 확인하는 if문 탈출
			}
	...
	public void practice5() {
		...
		for(String ani : zoo) {
			if(ani.equals(search)) {
				found = true;
				break;
			}
				
		}
		System.out.println(search + " 찾았습니까? " + (found ? "찾았어요." : "못 찾았어요."));
	}
