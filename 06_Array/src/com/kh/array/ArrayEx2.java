	...
	*/
	...
	public void method1() {
		...
		public void practice17() {
			...
			for( String 통닭     :      chickenMenu    ) {
				System.out.println(통닭);
			}
	...
	// 햄버거메뉴 6개 작성 for -each 모두 출력
		String a = "한개";
		String[] burgerMenu = {"빅맥", "불고기", "치즈", "더블", "소고기", "돼지고기"};
			for(String 버거 : burgerMenu) {
				System.out.println(버거);
			}
			
	}
	
		public void pratcice19() {
			
		
			String[] carBrand = {"benz", "bmw", "audi"};
			for(String 차 : carBrand){
