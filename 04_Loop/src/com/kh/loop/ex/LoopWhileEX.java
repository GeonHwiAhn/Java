...
import java.util.Scanner;
	...
	/*public : 어디서든 접근 가능한, 전체 공개
	  ...
	  default : 같은 폴더 안에서 접근 가능, protected보다 제한되게 접근 가능
...
public class LoopWhileEX {
	...
	/*
	 public static void kh카페(){
	 	...
	 	system.out.println("kh카페에 오신걸 환영합니다.^^");
	 					+	원하는 메뉴를 입력해주세요 \n.
	 					+ ("1 아메리카노 2 카페라떼 3 녹차 4흑당버블티 5. 주문취소";
	 	String menu = sc.next();
	...
	/*
	 ...
	 만약에 1 미만의 숫자가 입력됐다면 1 이상의 숫자를 입력하세요 출력하기
	...
	public static void getCoffee() {
		...
		while(money < coffeePrice) {
			System.out.println("돈이 부족합니다. 커피를 구매하기 위해\n"
								+ "더 많은 돈을 넣어주세요.	");
